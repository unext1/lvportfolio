            ...
            <div className="md:max-w-6xl md:mx-auto">
              <div className="md:flex md:flex-wrap">
                <div className="text-center md:w-1/2 md:text-left md:pt-16">
                  <h1 className="mb-4 text-3xl font-bold leading-tight text-white md:text-6xl">Laurynas Valiulis</h1>

                  <p className="text-indigo-200 md:text-lg md:pr-48">
                ...
                <div className="absolute right-0 md:w-1/2 ">
                  <div className="hidden md:block">
                    <div className="text-center">
                      <i className="z-50 text-blue-500 fa fa-laptop" style={{ fontSize: '400px' }}></i>
                    </div>
                  </div>
                </div>
              </div>
